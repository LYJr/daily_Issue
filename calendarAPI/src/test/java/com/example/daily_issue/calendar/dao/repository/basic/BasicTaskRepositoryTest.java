...
//    RepeatableTaskRepository repeatableTaskRepository;
    ...
    {
        List<BasicTaskEntity> tasks = basicTaskRepository.findByTaskOwner(member);
        System.out.println(tasks.size());
    }
    ...
    public void getBasicTasksByMemberAndDisplayDateRange()
    {
        ...
        List<BasicTaskEntity> tasks = basicTaskRepository.findByDisplayableBasicTasks(displayDateRange);
        List<RepeatableTaskEntity> repeatableTasks = basicTaskRepository.findByDisplayableRepeatableTasks(displayDateRange);
